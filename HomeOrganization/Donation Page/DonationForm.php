	...
	<div class="form-w3layouts">
		<form action="form.php" method="post">
			<div class="form-control"> 
				...
				<input type="text" id="name" name="txtname" placeholder="Your Name" title="Please enter your Full Name" required="">
				<div class="clear"></div>
			</div>
		
			<div class="form-control">	
				<label class="header">Email <span>*</span> </label>
				<input type="email" id="email" name="txtemail" placeholder="mail@example.com" title="Please enter a Valid Email Address" required="">
				<div class="clear"></div>
			</div>
			...
			<div class="form-control">	
				...
				<input type="tel" id="usrtel" name="txtusrtel" placeholder="Your Phone Number" title="Please enter Your Phone Number" required="">
				<div class="clear"></div>
			</div>	
			<div class="form-control">	
				<label class="header">Donation amount($) <span>*</span> </label>	
				<input type="tel" id="usrtel" name="usrtel1" placeholder="20" title="Please enter Your Amount" required="">
				<div class="clear"></div>
			</div>	
			<div class="form-control">
			...
			<div class="form-control">
				<input type="submit" value="Donate" class="register" title="Click here to Register">
				<div class="clear"></div>
			</div>	
